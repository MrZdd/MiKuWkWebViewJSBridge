#
# Be sure to run `pod lib lint MiKuWkWebViewJSBridge.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'MiKuWkWebViewJSBridge'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MiKuWkWebViewJSBridge.'
